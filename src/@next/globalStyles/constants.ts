...
export const blue = "#ff9b42ff";
export const blueDark = "#ff9b42ff";
...
export const darkGreen = "#ff9b42ff";
...
//  todajoia theme colors

export const lightGrey = "#f5f5f5";
export const grey = "#e5e5e5";
export const darkGrey = "rgba(0,0,0,.54)";
...
export const theme = {
  ...
  primary: black,
  primaryDark: darkGrey,
  primaryLight: grayLight,
...
export const baseFontSize = "0.8rem"; // 16px
